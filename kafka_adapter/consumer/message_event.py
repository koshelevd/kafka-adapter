...
class DurableMessageEvent:
    def __init__(self, handler: Callable, retry_topic: str, retry_count: int, retry_timeout: int,
...
class MessageEventFactory:
    ...
    @classmethod
    async def create_durable_event(cls, handler: Callable, retry_topic: str, retry_count: int, retry_timeout: int,
                                   producer: KafkaProducer) -> DurableMessageEvent:
